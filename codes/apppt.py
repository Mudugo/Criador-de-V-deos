...
def obter_imagens_musicapt():
    ...
    audio_arquivo = "C:/Users/isaacholanda/Desktop/Cria Videos/narracao/audiopt.mp3"
    
    return imagens, musica_fundo, audio_arquivo

def gerar_videopt():
    imagens, musica_fundo, audio_arquivo = obter_imagens_musicapt()
    ...
    video_path = os.path.join(script_dir, "videopt.mp4")
