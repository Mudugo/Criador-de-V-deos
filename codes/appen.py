...
def obter_imagens_musicaen():
    ...
    audio_arquivo = "C:/Users/isaacholanda/Desktop/Cria Videos/narracao/audioen.mp3"
    
    return imagens, musica_fundo, audio_arquivo

def gerar_videoen():
    imagens, musica_fundo, audio_arquivo = obter_imagens_musicaen()
    ...
    video_path = os.path.join(script_dir, "videoen.mp4")
