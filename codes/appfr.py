...
def obter_imagens_musicafr():
    ...
    audio_arquivo = "C:/Users/isaacholanda/Desktop/Cria Videos/narracao/audiofr.mp3"
    
    return imagens, musica_fundo, audio_arquivo

def gerar_videofr():
    imagens, musica_fundo, audio_arquivo = obter_imagens_musicafr()
    ...
    video_path = os.path.join(script_dir, "videofr.mp4")
