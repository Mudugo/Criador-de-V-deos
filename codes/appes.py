...
def obter_imagens_musicaes():
    ...
    audio_arquivo = "C:/Users/isaacholanda/Desktop/Cria Videos/narracao/audioes.mp3"
    
    return imagens, musica_fundo, audio_arquivo

def gerar_videoes():
    imagens, musica_fundo, audio_arquivo = obter_imagens_musicaes()
    ...
    video_path = os.path.join(script_dir, "videoes.mp4")
