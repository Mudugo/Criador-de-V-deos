...
def obter_imagens_musicaal():
    ...
    audio_arquivo = "C:/Users/isaacholanda/Desktop/Cria Videos/narracao/audioal.mp3"
    
    return imagens, musica_fundo, audio_arquivo

def gerar_videoal():
    imagens, musica_fundo, audio_arquivo = obter_imagens_musicaal()
    ...
    video_path = os.path.join(script_dir, "videoal.mp4")
